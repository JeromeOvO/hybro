...
## Markdown Formatting
- Use plain prose for a short answer. Add `###` section headers only when they
  materially improve readability; do not force a TL;DR, Top N, provenance, or
  process-summary template onto every response.
