      ...
      <div className="page-content space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            onClick={() => router.push(routes.manage.register)}
          >
        ...
        {filteredAgents.length > 0 ? (
              ...
              <tbody>
                {filteredAgents.map((agent) => (
                  <tr
                    ...
                    onClick={() => router.push(routes.manage.agent(agent.agent_id))}
                  >
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                router.push(routes.manage.agent(agent.agent_id))
                              }}
                            >
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            ...
                            >
                              <a
                                href={routes.agent(agent.agent_id)}
                                target="_blank"
          ...
          <div className="text-center py-12">
            ...
            {myAgents.length === 0 ? (
              <Button onClick={() => router.push(routes.manage.register)}>
                <Plus className="h-4 w-4 mr-2" />
