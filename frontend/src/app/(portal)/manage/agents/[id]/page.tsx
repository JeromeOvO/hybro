  ...
  const handleDeleteAgent = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        refreshMyAgents()
        router.push(routes.manage.agents)
      } else {
      ...
      <div className="page-loading">
        <Card className="w-full max-w-md border-dashed">
          ...
          <CardFooter className="flex justify-center">
            <Button onClick={() => router.push(routes.manage.agents)} variant="default">
    ...
    <div className="page-container">
      <div className="page-content space-y-8">
        ...
        <div className="flex items-center justify-between">
          <Button
            variant="ghost"
            onClick={() => router.push(routes.manage.agents)}
              ...
              {!userId ? (
                <>
                  ...
                  <Button
                    variant="default"
                    className="mt-4"
                    onClick={() => router.push(`/sign-in?redirect_url=${encodeURIComponent(routes.manage.agent(agentId))}`)}
                  >
                    Sign In
                  </Button>
                </>
