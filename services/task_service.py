...
class TaskService:
    ...
    async def create_task(self, user_input: str) -> str:
        ...
        task_id = await self.database_service.add_base_task(root_task)
        return task_id
    ...
    async def get_task(self, task_id: str) -> Optional[BaseTask]:
        ...
        """
        return await self.database_service.get_base_task_by_task_id(task_id)
    
    async def get_tasks(self, query: Optional[Dict[str, Any]] = None, limit: int = 0) -> List[BaseTask]:
        """
        ...
        """
        return await self.database_service.get_base_tasks_by_session_id(query, limit)
    ...
    async def update_task(self, task_id: str, update_data: Dict[str, Any]) -> bool:
        ...
        """
        return await self.database_service.update_base_task_by_task_id(task_id, update_data)
    ...
    async def update_task_history(self, task_id: str, history: List[Dict[str, Any]]) -> bool:
        ...
        Returns:
            bool: True if update was successful.
        """
        base_task = await self.get_task(task_id)
        old_history: List[Dict[str, Any]] = []
        if base_task and base_task.task and base_task.task.history:
            for msg in base_task.task.history:
        ...
        return await self.database_service.update_base_task_by_task_id(task_id, new_history)
    ...
    async def delete_task(self, task_id: str) -> bool:
        ...
        """
        return await self.database_service.delete_base_task_by_task_id(task_id)
    ...
    async def create_meta_task(self, root_task_id: str, subtask_id: str, description: str, step: Optional[int] = None, priority: Optional[int] = None, dependencies: Optional[List[str]] = None) -> str:
        """
        ...
        child_task_id = await self.database_service.add_meta_task(root_task_id, child_task)
        return child_task_id

    async def get_meta_task(self, child_task_id: str) -> Optional[MetaTask]:
        """
        ...
        """
        return await self.database_service.get_meta_task_by_task_id(child_task_id)

    async def get_meta_tasks_by_parent(self, root_task_id: str) -> List[MetaTask]:
        """
        ...
        """
        return await self.database_service.get_meta_tasks_by_parent(root_task_id)

    async def update_meta_task(self, child_task_id: str, update_data: Dict[str, Any]) -> bool:
        """
        Update a child task
        ...
        Returns:
            bool: True if update was successful
        """
        return await self.database_service.update_meta_task_by_task_id(child_task_id, update_data)
    ...
    async def delete_child_task(self, child_task_id: str) -> bool:
        ...
        Returns:
            bool: True if deletion was successful
        """
        return await self.database_service.delete_meta_task_by_task_id(child_task_id)
    ...
    async def update_child_task_status(self, child_task_id: str, status: TaskStatus) -> bool:
        ...
        return await self.update_meta_task(child_task_id, update_data)
    
    async def create_subtasks_with_openai_content(self, root_task_id: str, content: str) -> Optional[BaseTask]:
        """
    ...
    async def update_task_session(self, session_id: str, update_data: Dict[str, Any]) -> bool:
        ...
        Returns:
            bool: True if update was successful
        """
        return await self.database_service.update_task_session_by_session_id(session_id, update_data)
    ...
    async def get_base_tasks_by_session(self, session_id: str) -> List[BaseTask]:
        """
        ...
        """
        return await self.database_service.get_base_tasks_by_session_id(session_id)
    ...
    async def update_root_task_in_session(self, session_id: str, root_task_id: str, update_data: Dict[str, Any]) -> bool:
        ...
        Returns:
            bool: True if update was successful
        """
        return await self.database_service.update_base_task_by_task_id(root_task_id, update_data)  
    ...
    async def delete_root_task_from_session(self, session_id: str, root_task_id: str) -> bool:
        ...
        Returns:
            bool: True if deletion was successful
        """
        return await self.database_service.delete_base_task_by_task_id(root_task_id)
