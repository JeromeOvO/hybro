...
still need the legacy upload/presign methods, while `app_shell/s3_service.py`
is retained only as an SDK-free compatibility shim for tests and legacy import
