...
from models.request import AgentGroupCreateRequest, AgentGroupUpdateRequest
from services.database_service import db_service

router = APIRouter()


@router.post("/agentGroups/create")
...
@router.post("/agentGroups/list")
async def list_agent_groups(request: Request):
    """
...
@router.post("/agentGroups/get")
async def get_agent_group(request: Request):
    """
...
@router.post("/agentGroups/update")
async def update_agent_group(request: Request):
    """
...
@router.post("/agentGroups/delete")
async def delete_agent_group(request: Request):
    """
