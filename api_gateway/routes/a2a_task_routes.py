...
router = APIRouter()
task_store: A2ATaskReader | None = None

def bind_a2a_task_dependencies(store: A2ATaskReader) -> None:
    global task_store

    task_store = store


def get_task_store() -> A2ATaskReader:
...
async def get_task_status(
    ...
    db: A2ATaskReader = Depends(get_task_store),
) -> dict[str, Any]:
    """
