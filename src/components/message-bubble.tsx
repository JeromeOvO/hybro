...
import { UserAttachmentCard } from './conversation/UserAttachmentCard'
  ...
  return (
    <div className="w-full">
        <div
          ref={bubbleRef}
          onCopy={handleCopy}
          className="rounded-xl p-4 shadow-sm bg-secondary text-secondary-foreground message-bubble select-text"
        >
