  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-sidebar/60 backdrop-blur-xl text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col border-r border-white/10",
          className
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar/60 backdrop-blur-xl text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden border-r border-white/10"
          style={
            {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed bottom-0 z-10 hidden h-[calc(100vh-var(--banner-offset,0px))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
      ...
      >
        <div
          ...
          className="bg-sidebar/60 backdrop-blur-xl border-r border-white/10 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-lg group-data-[variant=floating]:shadow-black/5"
        >
          {children}
        </div>
      </div>
  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md text-left text-sm outline-hidden ring-sidebar-ring transition-all duration-150 ease-out hover:bg-black/10 dark:hover:bg-white/15 hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-black/15 dark:active:bg-white/20 active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-black/15 dark:data-[active=true]:bg-white/15 data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[active=true]:border-l-2 data-[active=true]:border-l-sidebar-primary data-[state=open]:hover:bg-black/15 dark:data-[state=open]:hover:bg-white/15 group-data-[collapsible=icon]:h-10! group-data-[collapsible=icon]:w-8! group-data-[collapsible=icon]:p-2! group-data-[collapsible=icon]:border-l-0 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 border-l-2 border-l-transparent hover:border-l-sidebar-primary/50",
  {
    variants: {
      ...
      size: {
        ...
        sm: "h-7 text-xs px-2",
        lg: "h-12 text-sm px-3 group-data-[collapsible=icon]:p-0!",
      },
    },
    defaultVariants: {
      variant: "default",
