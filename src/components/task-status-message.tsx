...
export function TaskStatusMessage({
  ...
  if (status === PROCESSING_STATUS.COMPLETED && content) {
    ...
    return (
      <div className="flex w-full animate-in fade-in slide-in-from-bottom-2 duration-300">
        <div className="flex-1 min-w-0 overflow-hidden rounded-xl p-4 shadow-sm border border-emerald-200 dark:border-emerald-500/20 bg-emerald-50 dark:bg-emerald-500/12 message-bubble text-emerald-600 dark:text-emerald-400">
  ...
  if (isFailureState(status)) {
    ...
    return (
      <div className="flex w-full animate-in fade-in slide-in-from-bottom-2 duration-300">
        <div className="flex-1 min-w-0 overflow-hidden rounded-xl p-4 shadow-sm border border-red-200 dark:border-red-500/20 bg-red-50 dark:bg-red-500/12 message-bubble text-red-600 dark:text-red-400">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <AgentLink
                agentId={agentId}
